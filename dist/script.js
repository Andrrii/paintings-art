...
var checkTextInputs = function checkTextInputs(selector) {
  var inputs;
  return regeneratorRuntime.async(function checkTextInputs$(_context) {
    while (1) {
...
var drop = function drop() {
  ...
  function unhighlights(item)
  /* забираєм підсвітку |input| */
  {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      var dots; // Якщо ім'я картинки занадто довге то ставим |...+.png|
...
var forms = function forms() {
  ...
  upload.forEach(function (item) {
    /* Загрузка зображення на калькулятор |drag and drop| */
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (event) {
      ...
      var api; // Шукає значення у прарoдителей
...
/*!**********************************!*\
  !*** ./src/js/modules/modals.js ***!
  \**********************************/
/*! exports provided: default, timeout, calcScroll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _filter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./filter */ "./src/js/modules/filter.js");




var pictureSize = function pictureSize(imageSelector) {
   ...
   */
  var blocks = document.querySelectorAll(imageSelector);

  function showImg(block) {
    var img = block.querySelector('img');
    img.src = img.src.slice(0, -4)
    /* |-4|- обрізаєм 4 ост.символи */
    + "-1.png";
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (e) {
      ...
      function step(time) {
        ...
        /* Вичисляєм наскільки рухатись і в яку сторону */
...
var showMoreStyles = function showMoreStyles(trigger, styles, wrapper) {
  var btn = document.querySelector(trigger); //   Простий спосіб без серверу
  //#region       
  // cards.forEach(card => {
  ...
  /* Створюєм карточки з допомогою js */
  {
